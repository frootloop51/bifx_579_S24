...
write.csv(allDF2, "~/Documents/snaptronwork/snapout_analysis/caudate_sixtypercent.csv")
#Check output:
#caudate_sixtypercent <- read.csv("~/Documents/snaptronwork/snapout_analysis/caudate_sixtypercent.csv", header = TRUE, sep = ",")
