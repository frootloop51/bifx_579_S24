...
phenotype_SRP035524 <- read.csv("SRP035524/SRP035524.csv", header = TRUE, sep = ",")
...
pcaData_SRP035524 <- DESeq2::plotPCA(rld_SRP035524, intgroup = "disease", returnData= TRUE)
pcaData_SRP035524
...
library(ggplot2)
ggplot(pcaData_SRP035524, aes(x = PC1, y = PC2, color = disease, shape = disease)) +
  geom_point(size =3) +
